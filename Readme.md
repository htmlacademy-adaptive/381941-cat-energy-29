...
* Студент: [Владимир Покладов](https://up.htmlacademy.ru/adaptive/29/user/381941).
* Наставник: [Анастасия Гущина].




# Добрый день! Не хватило времени доделать проект до конца. На текущий моментприсутствуют следующие недоработки и нужно время на их устранение: https://docs.google.com/spreadsheets/d/1MXojE7LkNIJgrmar9TOByDhjETpWFoGylCprPh40yz4/edit#gid=0
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-adaptive/381941-cat-energy-29) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии будет скопирован в ваш аккаунт.
...
[check-image]: https://github.com/htmlacademy-adaptive/381941-cat-energy-29/workflows/Project%20check/badge.svg?branch=master
[check-url]: https://github.com/htmlacademy-adaptive/381941-cat-energy-29/actions
